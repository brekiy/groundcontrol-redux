...
ENT.EscapeText = "Escape point"
ENT.DeliverText = "Deliver VIP"
ENT.PreventText = "Guard"
...
function ENT:drawHUD()
    ...
    local sameTeam = ply:Team() == self:GetVIPTeam()
    local pos = nil
