...
function GM:applyWeaponDataToWeaponClass(weaponData, primaryWeapon, slot)
    local wepClass = weapons.GetStored(weaponData.weaponClass) -- get the original SWEP properties
    wepClass.weight = wepClass.Desc_Weight -- apply weight to the weapon class
...
function GM:postInitEntity()
    local ak = {}
    ak.weaponClass = "act3_ak"
    ak.penetration = 17
    self:registerPrimaryWeapon(ak)

    local garand = {}
    garand.weaponClass = "act3_garand"
    garand.penetration = 20
    self:registerPrimaryWeapon(garand)

    local deagle = {}
    deagle.weaponClass = "act3_deagle"
    deagle.penetration = 13
    self:registerSecondaryWeapon(deagle)

    local knife = weapons.GetStored(self.KnifeWeaponClass)
    knife.weight = 0
    knife.dropsDisabled = true
    knife.isKnife = true
...
function getWeaponMagazine(wepObject)
    if wepObject then
        if wepObject.DefaultMagazine then
            return ACT3_GetMagazineType(wepObject.DefaultMagazine.Type)
        elseif wepObject.Magazine then
            return ACT3_GetMagazineType(wepObject.Magazine.Type)
        end
    else return nil end
end
...
--     flash.description = {{t = "Flashbang", font = "ChatFont", c = Color(255, 255, 255, 255)},
--         {t = "Blinds nearby enemies facing the grenade upon detonation.", font = "ChatFont", c = Color(255, 255, 255, 255)},
--         {t = "2x grenades.", font = "ChatFont", c = Color(255, 255, 255, 255)}
--     }
...
--     smoke.description = {{t = "Smoke grenade", font = "ChatFont", c = Color(255, 255, 255, 255)},
--         {t = "Provides a smoke screen to deter enemies from advancing or pushing through.", font = "ChatFont", c = Color(255, 255, 255, 255)},
--         {t = "2x grenades.", font = "ChatFont", c = Color(255, 255, 255, 255)}
--     }
...
--     spareGrenade.description = {{t = "Spare frag grenade", font = "ChatFont", c = Color(255, 255, 255, 255)},
--         {t = "Allows for a second frag grenade to be thrown.", font = "ChatFont", c = Color(255, 255, 255, 255)}
--     }
