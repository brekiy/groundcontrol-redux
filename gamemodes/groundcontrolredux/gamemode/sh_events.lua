...
GM:RegisterEvent("SPOT_KILL", "Spot kill", nil, 10, 10)
-- kill someone while being the last living team member
GM:RegisterEvent("ONE_MAN_ARMY", "One man army", nil, 15, 10)
GM:RegisterEvent("REPORT_ENEMY_DEATH", "Reported enemy death", nil, 5, 5)
...
GM:RegisterEvent("BLEED_OUT_KILL", "Enemy bled out", nil, 50, 20)
