...
CreateConVar("gc_run_speed_penalty_per_weight", 1, {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "how much runspeed is subtracted per unit of weight over the threshold", 0)
