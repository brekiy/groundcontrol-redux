...
function GM:RegisterCalibers()
    ...
    GAMEMODE:registerCaliber(".300 Win Mag", 32.2, 39)
    ...
    GAMEMODE:registerCaliber(".40 S&W", 16.7, 6)
    GAMEMODE:registerCaliber(".410 Bore", 21, 1)
    GAMEMODE:registerCaliber(".429 DE", 40, 12)
    GAMEMODE:registerCaliber(".44 Magnum", 24.5, 11)
    GAMEMODE:registerCaliber(".45 ACP", 20.85, 2)
    GAMEMODE:registerCaliber(".45 Colt", 25, 1)
    GAMEMODE:registerCaliber(".454 Casull", 30.4, 9)
    GAMEMODE:registerCaliber(".50 AE", 45, 9)
    GAMEMODE:registerCaliber(".50 Beowulf", 42, 12)
    GAMEMODE:registerCaliber(".50 BMG", 117.48, 51)
    GAMEMODE:registerCaliber(".50 GI", 28, 3)
    GAMEMODE:registerCaliber(".500 S&W", 46.5, 11, {".500", ".500 S&W Magnum", ".500 Magnum"})
    GAMEMODE:registerCaliber("10mm Auto", 17.25, 7, {"alyxgun"})
    ...
    GAMEMODE:registerCaliber("5.7x28MM", 6.15, 12)
    GAMEMODE:registerCaliber("6.8x43MM", 16.9, 24)
    GAMEMODE:registerCaliber("6x35MM", 10.7, 17)
    ...
    GAMEMODE:registerCaliber("9.3x64MM", 40, 34)
    GAMEMODE:registerCaliber("23x75MMR", 50, 2, {"23mm Shell"})
end
