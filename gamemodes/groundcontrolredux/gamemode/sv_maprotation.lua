...
GM:registerMapRotation("urbanwarfare_maps", {"ph_skyscraper_construct", "de_desert_atrocity_v3", "nt_isolation", "dm_zavod_yantar", "rp_downtown_v2", "rp_downtown_v4c_v2"})
