...
function GM:toggleLoadoutMenu()
    ...
    local helmetSelection = vgui.Create("GCArmorDisplay", panel)
    helmetSelection:SetSize(65, 65)
    helmetSelection:SetPos(400, 90)
    helmetSelection:SetCategory("helmet")
    helmetSelection:SetConVar("gc_armor_helmet")
    helmetSelection:CreateButtons()
    ...
    local ammoText = vgui.Create("DLabel", panel)
...
if !file.IsDir(GM.LoadoutSaveDirectory, "DATA") then
