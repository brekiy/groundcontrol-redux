AddCSLuaFile()
CreateConVar("gc_min_weight_speed_decrease", 7.5, {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE}, "Weight (kg) at which runspeed begins to be impacted", 1)
CreateConVar("gc_run_speed_penalty_per_weight", 0.65, {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE}, "Run speed penalty per kg over the threshold", 0)
