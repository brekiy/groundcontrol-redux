...
if CLIENT then
    function GM:GetAnnouncementSoundFromCache(announcerId, announcementId, seed)
        ...
        if !self.CachedAnnouncementSounds[randomSound] then -- create a new sound object, cache it and return it if it wasn't created yet
...
-- GHETTO DRUG BUST ANNOUNCER AND HIS ANNOUNCEMENTS
